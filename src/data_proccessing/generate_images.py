...
data_dir = "CTbrain/merged_images/augminted/Epidural3"  # Update with your data directory
output_dir = "CTbrain/merged_images/augminted/doubled/Epidural"  # Update with your desired output directory
...
times = int(num_files1/num_files2) * 3
times_directory = [times, 3]
print("TIMES:", times)
...
subdirectories = ['with', 'without']

for subdirectory in subdirectories:
    if subdirectory=='with':
        times = times_directory[0]
    else:
        times = times_directory[1]
